...
# # Best performing DSPy prompt configuration for fact filtering
# best_dspy_prompt = {
#     'prog': {
#         'lm': None,
#         'traces': [],
...
#                 'fact_before_filter': (
#                     '{"fact": [["imperial river", "is located in", "florida"], '
...
#                 'fact_before_filter': (
#                     '{"fact": [["jean jacques annaud", "born on", "1 october 1943"], '
...
#                 'fact_before_filter': (
#                     '{"fact": [["teafuaniua", "is on the", "east"], '
...
#                 'fact_before_filter': (
#                     '{"fact": [["allan dwan", "died on", "28 december 1981"], '
...
#                 'fact_before_filter': (
#                     '{"fact": [["sebasti n lelio watt", "received acclaim for directing", "gloria"], '
...
#                 ),
#                 'fact_after_filter': (
#                     '{"fact":[["gloria","is","1980 american thriller crime drama film"],'
#                     '["gloria","written and directed by","john cassavetes"],'
#                     '["a new life","directed by","alan alda"]]}'
#                 )
#             },
...
#                 'fact_before_filter': (
#                     '{"fact": [["the old guard", "is", "1960 french comedy film"], '
...
#                 'fact_before_filter': (
#                     '{"fact": [["aulad", "has music composed by", "chitragupta shrivastava"], '
...
#                 'fact_before_filter': (
#                     '{"fact": [["dow city", "had", "219 households"], '
...
#                 'fact_before_filter': (
#                     '{"fact": [["virgin mountain", "released in", "icelandic cinemas"], '
...
#                 'fact_before_filter': (
#                     '{"fact": [["the virtuous model", "is", "1919 american silent drama film"], '
...
#                 'used by top researchers and decision-makers worldwide. Your task is to filter '
#                 'facts based on their relevance to a given query, ensuring that the most crucial '
#                 'information is presented to these stakeholders. The query requires careful analysis '
#                 'and possibly multi-hop reasoning to connect different pieces of information. '
#                 'You must select up to 4 relevant facts from the provided candidate list that have '
#                 'a strong connection to the query, aiding in reasoning and providing an accurate answer. '
#                 'The output should be in JSON format, e.g., {"fact": [["s1", "p1", "o1"], ["s2", "p2", "o2"]]}, '
#                 'and if no facts are relevant, return an empty list, {"fact": []}. '
#                 'The accuracy of your response is paramount, as it will directly impact the decisions '
#                 'made by these high-level stakeholders. You must only use facts from the candidate list '
#                 'and not generate new facts. The future of critical decision-making relies on your '
#                 'ability to accurately filter and present relevant information.'
#             ),
#             'fields': [
#                 {
#                     'prefix': 'Question:',
